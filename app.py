...
classification_report_df = load_classification_report(CLASS_REPORT_PATH)
error_analysis_df = load_error_analysis(ERROR_ANALYSIS_PATH)
...
with tabs[1]:
    ...
    if classification_report_df is not None:
        ...
        st.info(
            ...
            "`python -m src.models.evaluate --model models/svm_best.joblib`"
        )
